...
try:
    ...
    # python-dotenv not installed yet, will use defaults
    pass

BASE_DIR = Path(__file__).resolve().parent.parent

SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-your-secret-key-change-in-production-12345')
...
# SQLite Database Configuration (Simple & Working)
DATABASES = {
    'default': {
